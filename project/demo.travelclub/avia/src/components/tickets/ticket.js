...
function substractDateDays(date1,utc1,date2,utc2) {
   ...
   // console.log(;
    ...
    //console.log(moment(m1-m2,'X').format("DD HH:mm"));


}

const Ticket = ({data}) => {
    const {route_segment, price} = data;
                        ...
                        <div className="theme-search-results-item-flight-sections">
                            <div className="theme-search-results-item-flight-section">
                                <div className={"row row-no-gutter row-eq-height"}>
                                    <div className="col-md-2"> {data.company ? data.company : "Заглушка"}</div>
                                                            ...
                                                            route_segment.map((item, index) =>
                                                                ...
                                                                <div key={`${index}_route_segment`}
                                                                    ...
                                                                    <div
                                                                        className="theme-search-results-item-flight-section-path-line-title">
                                                                        {
                                                                            route_segment.length - 1 != index && item.segment.end.airport_code
                                                                        }
                                                                    </div>
                                                                </div>
                                                            )
                    ...
                    <div className="col-md-2 ">
                        <div className="theme-search-results-item-book">
                            <div className="theme-search-results-item-price">
                                ...
                                <p className="theme-search-results-item-price-sign">эконом</p>
                            </div>
                                                    ...
                                                    route_segment.map((item, index) =>
                                                        <React.Fragment key={`${index}_flight-details-schedule-list`}>
                                                            <li>
                                                                ...
                                                                <div
                                                                    className="theme-search-results-item-flight-details-schedule-dots"></div>
                                                                ...
                                                                <p className="theme-search-results-item-flight-details-schedule-fly-time"> {
                                                                    getTimeFromMins(item.segment.time)
                                                                }
                                                                </p>
                                                                <div
                                                            ...
                                                            </li>
                                                            {
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <p className="theme-search-results-item-flight-details-schedule-transfer">Смена
                                                                        самолета
