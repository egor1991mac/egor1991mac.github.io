...
<div class="bx-filter<? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal" ?>">
    <div class="bx-filter-section">
        ...
        <? //if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?><!--col-sm-6 col-md-4--><? //else:?><!--col-lg-12-->
        <? //endif?><!-- bx-filter-title">--><? //echo GetMessage("CT_BCSF_FILTER_TITLE")?><!--</div></div>-->
        <!--		-->
        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
            ...
            <? endforeach; ?>
                    ...
                    if ($arItem["DISPLAY_EXPANDED"] == "Y"):?>bx-active<?endif ?>">
                        ...
                        <div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							<span class="bx-filter-parameters-box-hint"><?= $arItem["NAME"] ?>
								...
								<i data-role="prop_angle" class="fa fa-angle-<?
                                if ($arItem["DISPLAY_EXPANDED"] == "Y"):?>up<? else:?>down<?endif ?>"></i>
							</span>
                        </div>
                ...
                ?>
                    ...
                    <div class="bx-filter-block control-bottom">
                        <div class="bx-filter-parameters-box-container d-flex justify-content-between">
                            <button
