...
$MESS["REGISTER_WRONG_FRONT_EMAIL"] = "Введите корректный email.";
$MESS["REGISTER_WRONG_FRONT_PHONE"] = "Введите корректный телефон.";
$MESS["REGISTER_AGENCY_NAME_TITLE"] = "Юр. название";
$MESS["REGISTER_AGENCY_UNP_TITLE"] = "УНП агентства";
$MESS["REGISTER_AGENCY_NAME_TITLE"] = "Полное название агентства";
$MESS["REGISTER_AGENCY_LEGAL_ADDRESS_TITLE"] = "Юр. адрес";
$MESS["REGISTER_AGENCY_LEGAL_ADDRESS_TITLE"] = "Юр. адрес";
$MESS["REGISTER_AGENCY_BANK_NAME_TITLE"] = "Название банка";
$MESS["REGISTER_AGENCY_BANK_ADDRESS_TITLE"] = "Адрес банка";
$MESS["REGISTER_AGENCY_BANK_CODE_TITLE"] = "Код банка";
$MESS["REGISTER_AGENCY_CHECKING_ACCOUNT_TITLE"] = "Расчетный счет";
$MESS["REGISTER_AGENCY_ACCOUNT_CURRENCY_TITLE"] = "Валюта расчетного счета";
$MESS["REGISTER_AGENCY_OKPO_TITLE"] = "ОКПО";
$MESS["REGISTER_AGENCY_ACTUAL_ADDRESS_TITLE"] = "Фактический адрес";
$MESS["REGISTER_AGENCY_CONTRACT_NUMBER_TITLE"] = "Номер договора";
$MESS["REGISTER_AGENCY_CONTRACT_DF_TITLE"] = "Договор действует с";
$MESS["REGISTER_AGENCY_CONTRACT_DT_TITLE"] = "Договор действует по";
$MESS["REGISTER_AGENCY_CANCEL_TITLE"] = "Отмена";
?>