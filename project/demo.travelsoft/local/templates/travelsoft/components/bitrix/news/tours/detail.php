...
if (!isset($_GET['travelbooking']) || !isset($_GET['travelbooking']['adults'])) {
    $_GET['travelbooking']['adults'] = 1;
}
$GLOBALS = \array_merge($GLOBALS, \travelsoft\booking\Utils::getHTMLSearchOffersFormAndOffersListOnDetailPage([
    ...
    "search_form_component_template" => "inner-one-calendar",
    "offers_component_template" => "tsoperator__excursiontours",
    "booking_url" => "/booking/",
    "element_code" => $arResult["VARIABLES"]["ELEMENT_CODE"],
    "highlight_dates_parameters" => function () {
        return [
            "CALENDAR_FROM" => [
                "SERVICE_TYPE" => "excursiontour",
...
<?$ElementID = $APPLICATION->IncludeComponent(
	...
	"",
	Array(
		"favorites_html_hash" => md5("___travelsoft__".$GLOBALS["favorites_html"]),
    //    "TS:OPERATOR_HASH_FOR_CACHE" => md5($GLOBALS["SEARCH_OFFERS_RESULT_HTML"]) . md5($GLOBALS['SEARCH_FORM_HTML']),
